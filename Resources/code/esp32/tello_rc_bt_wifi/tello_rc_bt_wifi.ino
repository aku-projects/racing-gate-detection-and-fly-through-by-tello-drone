      ...
      if (Serial2.available()) 
      {
        ...
        if (separator != 0)
        {
            ...
            *separator = 0;
            ...
            {
              Serial.println(tagfound);
              Serial.println("aligned! Will go through hoop");
              BT_SERIAL.println(tagfound);
              BT_SERIAL.println("aligned! Will go through hoop");
            ...
            if (strcmp( separator, "rc 0 0 0 0" ) == 0)
             {
              Serial.println("No Hoops found!"); 
              BT_SERIAL.println("No Hoops found!");   
             }
            tello.sendCommand(separator);
//            delay(delaytime);
